...
--- After Day-3 ---
I learned these things as well, apart from the checklist I also learned how modern Python project management 
tools simplify dependency handling and environment setup. I got a better understanding of how virtual 
environments work behind the scenes, why project-specific dependencies are important, and how tools 
like uv make Python development more reproducible. I also became more comfortable working with VS Code 
and organizing Python projects in a structured way.
